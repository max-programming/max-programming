...
1. 🎉 Merged PR [#10](https://github.com/max-programming/globe-trotter/pull/10) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
2. 💪 Opened PR [#10](https://github.com/max-programming/globe-trotter/pull/10) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
3. 🎉 Merged PR [#9](https://github.com/max-programming/globe-trotter/pull/9) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
4. 💪 Opened PR [#9](https://github.com/max-programming/globe-trotter/pull/9) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
5. 🎉 Merged PR [#8](https://github.com/max-programming/globe-trotter/pull/8) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
