...
1. 💪 Opened PR [#6](https://github.com/max-programming/globe-trotter/pull/6) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
2. 🎉 Merged PR [#5](https://github.com/max-programming/globe-trotter/pull/5) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
3. 💪 Opened PR [#5](https://github.com/max-programming/globe-trotter/pull/5) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
4. 🎉 Merged PR [#4](https://github.com/max-programming/globe-trotter/pull/4) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
5. 💪 Opened PR [#4](https://github.com/max-programming/globe-trotter/pull/4) in [max-programming/globe-trotter](https://github.com/max-programming/globe-trotter)
